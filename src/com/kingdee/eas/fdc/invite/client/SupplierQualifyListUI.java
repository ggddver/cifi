...
//		return "入围供应商记录";
	...
	public void actionRemove_actionPerformed(ActionEvent e) throws Exception {
		...
		SupplierQualifyInfo info = SupplierQualifyFactory.getRemoteInstance().getSupplierQualifyInfo(new ObjectUuidPK(id));
		FilterInfo filter = new FilterInfo();
		filter.getFilterItems().add(new FilterItemInfo("SourceBillid", info.getNumber(), CompareType.EQUALS));
