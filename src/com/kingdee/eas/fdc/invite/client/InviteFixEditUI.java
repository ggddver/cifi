...
public class InviteFixEditUI extends AbstractInviteFixEditUI
{
    ...
    public void onLoad() throws Exception {
		...
		this.kdtEntry.getHeadRow(0).getCell("supComment").setValue("是否优秀供方");
		this.kdtEntry.getColumn("supComment").getStyleAttributes().setHorizontalAlign(HorizontalAlignment.CENTER);
		this.kdtEntry.getColumn("grade").getStyleAttributes().setHorizontalAlign(HorizontalAlignment.CENTER);
		setRequired(kdtEntry, new String[] {"supplier", "fix", "supComment", "description"});
	}
    private void setRequired(KDTable table, String[] cols) {
    ...
    private void checkRequired() {
    	for(int i=0; i<kdtEntry.getRowCount(); i++) {
    		...
    		boolean b3 = kdtEntry.getCell(i, "supComment").getValue() == null;
    		boolean b4 = kdtEntry.getCell(i, "description").getValue() == null;
    		if(b1||b2||b3||b4) {
