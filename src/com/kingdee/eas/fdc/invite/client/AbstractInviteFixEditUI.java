 ...
 * output class name
 */
public abstract class AbstractInviteFixEditUI extends com.kingdee.eas.fdc.invite.client.BaseInviteEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInviteFixEditUI.class);
    protected com.kingdee.eas.fdc.invite.InviteFixHeadInfo editData = null;
     ...
     */
    public AbstractInviteFixEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractInviteFixEditUI.class.getName());
		...
		String kdtEntryStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol1\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol3\"><c:Protection hidden=\"true\" /></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"supplier\" t:width=\"200\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"grade\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol1\" /><t:Column t:key=\"fix\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"remark\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"3\" t:styleID=\"sCol3\" /><t:Column t:key=\"supComment\" t:width=\"175\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"description\" t:width=\"250\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header1\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{supplier}</t:Cell><t:Cell>$Resource{grade}</t:Cell><t:Cell>$Resource{fix}</t:Cell><t:Cell>$Resource{remark}</t:Cell><t:Cell>$Resource{supComment}</t:Cell><t:Cell>$Resource{description}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
        ...
        this.kdtEntry.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
            public void editStopped(com.kingdee.bos.ctrl.kdf.table.event.KDTEditEvent e) {
                ...
                this.kdtEntry.putBindContents("editData",new String[] {"supplier","supplier.grade.name","fix","remark","supComment","description"});


        this.kdtEntry.checkParsed();
        KDFormattedTextField kdtEntry_fix_TextField = new KDFormattedTextField();
        kdtEntry_fix_TextField.setName("kdtEntry_fix_TextField");
        kdtEntry_fix_TextField.setVisible(true);
        kdtEntry_fix_TextField.setEditable(true);
        kdtEntry_fix_TextField.setHorizontalAlignment(2);
        kdtEntry_fix_TextField.setDataType(1);
        	kdtEntry_fix_TextField.setMinimumValue(new java.math.BigDecimal("-999.9999999999"));
        	kdtEntry_fix_TextField.setMaximumValue(new java.math.BigDecimal("999.9999999999"));
        kdtEntry_fix_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntry_fix_CellEditor = new KDTDefaultCellEditor(kdtEntry_fix_TextField);
        this.kdtEntry.getColumn("fix").setEditor(kdtEntry_fix_CellEditor);
        ...
        KDComboBox kdtEntry_supComment_ComboBox = new KDComboBox();
        kdtEntry_supComment_ComboBox.setName("kdtEntry_supComment_ComboBox");
        kdtEntry_supComment_ComboBox.setVisible(true);
        kdtEntry_supComment_ComboBox.addItems(EnumUtils.getEnumList("com.kingdee.eas.fdc.invite.FixSupCommentEnum").toArray());
        KDTDefaultCellEditor kdtEntry_supComment_CellEditor = new KDTDefaultCellEditor(kdtEntry_supComment_ComboBox);
        this.kdtEntry.getColumn("supComment").setEditor(kdtEntry_supComment_CellEditor);
        KDTextField kdtEntry_description_TextField = new KDTextField();
        kdtEntry_description_TextField.setName("kdtEntry_description_TextField");
        kdtEntry_description_TextField.setMaxLength(255);
        KDTDefaultCellEditor kdtEntry_description_CellEditor = new KDTDefaultCellEditor(kdtEntry_description_TextField);
        this.kdtEntry.getColumn("description").setEditor(kdtEntry_description_CellEditor);
    ...
    public void initUIContentLayout()
    {
        ...
        contNumber.setBounds(new Rectangle(711, 36, 270, 19));
        this.add(contNumber, new KDLayout.Constraints(711, 36, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contName.setBounds(new Rectangle(365, 13, 270, 19));
        this.add(contName, new KDLayout.Constraints(365, 13, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contEntry.setBounds(new Rectangle(13, 71, 959, 467));
        this.add(contEntry, new KDLayout.Constraints(13, 71, 959, 467, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
...
contEntry.getContentPane().setLayout(new BorderLayout(0, 0));        contEntry.getContentPane().add(kdtEntry, BorderLayout.CENTER);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entry.fix", java.math.BigDecimal.class, this.kdtEntry, "fix.text");
		dataBinder.registerBinding("entry.remark", String.class, this.kdtEntry, "remark.text");
		dataBinder.registerBinding("entry.supComment", com.kingdee.util.enums.Enum.class, this.kdtEntry, "supComment.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.InviteFixEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.invite.InviteFixHeadInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entry.fix", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entry.remark", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entry.supComment", ValidateHelper.ON_SAVE);    
...
//        sic.add(new SelectorItemInfo("entry.number"));
    ...
    sic.add(new SelectorItemInfo("entry.fix"));
    sic.add(new SelectorItemInfo("entry.remark"));
    sic.add(new SelectorItemInfo("entry.supComment"));
    ...
    protected class ActionFixALine extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractInviteFixEditUI.this, "ActionFixALine", "actionFixALine_actionPerformed", e);
        }
    }
    ...
    protected class ActionFixILine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractInviteFixEditUI.this, "ActionFixILine", "actionFixILine_actionPerformed", e);
        }
    }
    ...
    protected class ActionFixRLine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractInviteFixEditUI.this, "ActionFixRLine", "actionFixRLine_actionPerformed", e);
        }
    }
    ...
    protected class ShowProjects extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractInviteFixEditUI.this, "ShowProjects", "showProjects_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "InviteFixEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.fdc.invite.client.InviteFixEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.fdc.invite.InviteFixHeadFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.fdc.invite.InviteFixHeadInfo objectValue = new com.kingdee.eas.fdc.invite.InviteFixHeadInfo();
    	...
    	return "/bim/fdc/invite/InviteFixHead";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.fdc.invite.app.InviteFixQuery");
	}
