 ...
 * output class name
 */
public abstract class AbstractSupplierQualifyListUI extends com.kingdee.eas.fdc.invite.client.BaseInviteListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSupplierQualifyListUI.class);
    /**
     * output class constructor
     */
    public AbstractSupplierQualifyListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSupplierQualifyListUI.class.getName());
...
contBaseInvite.getContentPane().setLayout(new BorderLayout(0, 0));        contBaseInvite.getContentPane().add(tblBaseInvite, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.SupplierQualifyListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "SupplierQualifyListUI");
    }
