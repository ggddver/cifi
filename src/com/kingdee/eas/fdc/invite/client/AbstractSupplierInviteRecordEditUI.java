...
public abstract class AbstractSupplierInviteRecordEditUI extends com.kingdee.eas.fdc.invite.client.BaseInviteEditUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        contRemark.setBounds(new Rectangle(13, 81, 954, 76));
        this.add(contRemark, new KDLayout.Constraints(13, 81, 954, 76, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
