...
public class SupplierQualifyPrintDataProvider extends FDCBillDataProvider{
	private static final Logger logger = Logger.getLogger(SupplierQualifyPrintDataProvider.class);
	private HashMap map = null;
	
	public SupplierQualifyPrintDataProvider(String billId, IMetaDataPK mainQuery) {
		super(billId, mainQuery);
		// TODO Auto-generated constructor stub
	}
	
	public SupplierQualifyPrintDataProvider(String billId,IMetaDataPK mainQuery,HashMap map)
	{
		super(billId, mainQuery);
		this.map = map;
	}
