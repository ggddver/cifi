...
public class InviteDocumentsPrintDataProvider extends FDCBillDataProvider{
	private static final Logger logger = Logger.getLogger(InviteDocumentsPrintDataProvider.class);
	
	private HashMap map = null;
	
	public InviteDocumentsPrintDataProvider(String billId, IMetaDataPK mainQuery) {
		super(billId, mainQuery);
		// TODO Auto-generated constructor stub
	}
	
	public InviteDocumentsPrintDataProvider(String billId,IMetaDataPK mainQuery,HashMap map)
	{
		super(billId, mainQuery);
		this.map = map;
	}
