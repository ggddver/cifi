...
public abstract class AbstractInviteTenderPlanningEditUI extends com.kingdee.eas.fdc.invite.client.BaseInviteEditUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        contNumber.setBounds(new Rectangle(903, 10, 270, 19));
        this.add(contNumber, new KDLayout.Constraints(903, 10, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contEntry.setBounds(new Rectangle(10, 41, 973, 206));
        this.add(contEntry, new KDLayout.Constraints(10, 41, 973, 206, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contScope.setBounds(new Rectangle(10, 254, 973, 139));
        this.add(contScope, new KDLayout.Constraints(10, 254, 973, 139, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contPayMethod.setBounds(new Rectangle(10, 401, 973, 139));
        this.add(contPayMethod, new KDLayout.Constraints(10, 401, 973, 139, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //contCreator
