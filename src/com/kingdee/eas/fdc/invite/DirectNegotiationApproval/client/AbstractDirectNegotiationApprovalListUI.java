 ...
 * output class name
 */
public abstract class AbstractDirectNegotiationApprovalListUI extends com.kingdee.eas.fdc.invite.client.BaseInviteListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDirectNegotiationApprovalListUI.class);
    /**
     * output class constructor
     */
    public AbstractDirectNegotiationApprovalListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDirectNegotiationApprovalListUI.class.getName());
...
contBaseInvite.getContentPane().setLayout(new BorderLayout(0, 0));        contBaseInvite.getContentPane().add(tblBaseInvite, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.DirectNegotiationApproval.app.DirectNegotiationApprovalListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.DirectNegotiationApproval.client", "DirectNegotiationApprovalListUI");
    }
    ...
    {
        return new String[] {"id","state","number","name","inviteType.name","inviteForm","PriceMode","paperIsComplete","scalingRules","creator.name","createTime","auditor.name","auditTime","purchaseMode"};
    }
