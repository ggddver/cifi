...
import com.kingdee.bos.workflow.monitor.client.ShowAssignmentList;
import com.kingdee.bos.dao.IObjectValue;
import com.kingdee.bos.dao.ormapping.ObjectUuidPK;
import com.kingdee.eas.fdc.invite.DirectNegotiationApproval.basedata.EstimatedAmtFactory;
import com.kingdee.eas.fdc.invite.DirectNegotiationApproval.basedata.EstimatedAmtInfo;
import com.kingdee.eas.fdc.invite.DirectNegotiationApproval.basedata.IEstimatedAmt;
 ...
 * output class name
 */
public class EstimatedAmtListUI extends AbstractEstimatedAmtListUI {
	private static final Logger logger = CoreUIObject
			.getLogger(EstimatedAmtListUI.class);

	/**
	 * output class constructor
	 */
	public EstimatedAmtListUI() throws Exception {
		super();
	}
...
//		00000000-0000-0000-0000-000000000000CCE7AED4
		if ("00000000-0000-0000-0000-000000000000CCE7AED4".equals(SysContext
	...
	public void actionEdit_actionPerformed(ActionEvent e) throws Exception {
		...
		EstimatedAmtInfo info = EstimatedAmtFactory.getRemoteInstance().getEstimatedAmtInfo(new ObjectUuidPK(id));
		if(info.isUse() == true) {
	...
	public void actionCancel_actionPerformed(ActionEvent e) throws Exception {
		checkSelected();
		String id = getSelectedKeyValue();
		IEstimatedAmt iestimate = EstimatedAmtFactory.getRemoteInstance();
		EstimatedAmtInfo info = iestimate.getEstimatedAmtInfo(new ObjectUuidPK(
				id));
		if (!info.isUse()) {
			MsgBox.showWarning("未启用数据无需禁用");
			SysUtil.abort();
		}
	...
	protected com.kingdee.eas.framework.ICoreBase getBizInterface()
			throws Exception {
		return com.kingdee.eas.fdc.invite.DirectNegotiationApproval.basedata.EstimatedAmtFactory
				.getRemoteInstance();
	}
	...
	protected ITreeBase getTreeInterface() throws Exception {
		return com.kingdee.eas.fdc.invite.DirectNegotiationApproval.basedata.EstimatedAmtTreeFactory
				.getRemoteInstance();
	}
	...
	protected String getGroupEditUIName() {
		return com.kingdee.eas.fdc.invite.DirectNegotiationApproval.basedata.client.EstimatedAmtTreeEditUI.class
				.getName();
	}
