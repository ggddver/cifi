 ...
 * output class name
 */
public class EstimatedAmtEditUI extends AbstractEstimatedAmtEditUI {
	private static final Logger logger = CoreUIObject
			.getLogger(EstimatedAmtEditUI.class);
	 ...
	 */
	public EstimatedAmtEditUI() throws Exception {
		super();
	}
	...
	public void actionCancel_actionPerformed(ActionEvent e) throws Exception {
		if (!this.chkuse.isSelected()) {
			MsgBox.showWarning("未启用，无需禁用");
			SysUtil.abort();
		}
	...
	public void setDataObject(IObjectValue dataObject) {
		...
		if (STATUS_ADDNEW.equals(getOprtState())) {
			editData
					.put(
							"treeid",
							(com.kingdee.eas.fdc.invite.DirectNegotiationApproval.basedata.EstimatedAmtTreeInfo) getUIContext()
