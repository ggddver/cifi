 ...
 * output class name
 */
public class DirectRuleListUI extends AbstractDirectRuleListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DirectRuleListUI.class);
    
    /**
     * output class constructor
     */
    public DirectRuleListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.fdc.invite.DirectNegotiationApproval.basedata.client.DirectRuleTreeEditUI.class.getName();
    }
