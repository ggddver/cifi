...
public class EstimatedAmtTreeControllerBean extends AbstractEstimatedAmtTreeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.invite.DirectNegotiationApproval.basedata.app.EstimatedAmtTreeControllerBean");
}