...
public class DirectRuleControllerBean extends AbstractDirectRuleControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.invite.DirectNegotiationApproval.basedata.app.DirectRuleControllerBean");
}