...
public class DirectRuleTreeControllerBean extends AbstractDirectRuleTreeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.invite.DirectNegotiationApproval.basedata.app.DirectRuleTreeControllerBean");
}