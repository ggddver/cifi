 ...
 * output class name
 */
public abstract class AbstractEstimatedAmtListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractEstimatedAmtListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractEstimatedAmtListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractEstimatedAmtListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.DirectNegotiationApproval.basedata.app.EstimatedAmtListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.DirectNegotiationApproval.basedata.client", "EstimatedAmtListUI");
    }
    ...
    {
        return com.kingdee.eas.fdc.invite.DirectNegotiationApproval.basedata.client.EstimatedAmtEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.fdc.invite.DirectNegotiationApproval.basedata.EstimatedAmtFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.fdc.invite.DirectNegotiationApproval.basedata.EstimatedAmtInfo objectValue = new com.kingdee.eas.fdc.invite.DirectNegotiationApproval.basedata.EstimatedAmtInfo();		
        return objectValue;
    }
