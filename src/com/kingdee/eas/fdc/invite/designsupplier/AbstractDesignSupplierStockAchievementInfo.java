...
public class AbstractDesignSupplierStockAchievementInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractDesignSupplierStockAchievementInfo()
    {
        this("id");
    }
    protected AbstractDesignSupplierStockAchievementInfo(String pkField)
    {
        super(pkField);
    }
    /**
