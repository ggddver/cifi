...
public class AbstractDesignSupplierStockLinkPersonInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractDesignSupplierStockLinkPersonInfo()
    {
        this("id");
    }
    protected AbstractDesignSupplierStockLinkPersonInfo(String pkField)
    {
        super(pkField);
    }
    /**
