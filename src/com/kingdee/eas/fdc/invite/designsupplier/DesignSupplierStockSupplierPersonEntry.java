...
public class DesignSupplierStockSupplierPersonEntry extends CoreBillEntryBase implements IDesignSupplierStockSupplierPersonEntry
{
    public DesignSupplierStockSupplierPersonEntry()
    {
        super();
        registerInterface(IDesignSupplierStockSupplierPersonEntry.class, this);
    }
    public DesignSupplierStockSupplierPersonEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IDesignSupplierStockSupplierPersonEntry.class, this);
    }
    ...
    private DesignSupplierStockSupplierPersonEntryController getController() throws BOSException
    {
        return (DesignSupplierStockSupplierPersonEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDesignSupplierStockSupplierPersonEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignSupplierStockSupplierPersonEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignSupplierStockSupplierPersonEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignSupplierStockSupplierPersonEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignSupplierStockSupplierPersonEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignSupplierStockSupplierPersonEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
