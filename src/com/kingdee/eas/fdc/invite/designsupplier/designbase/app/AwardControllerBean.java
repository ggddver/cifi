...
public class AwardControllerBean extends AbstractAwardControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.invite.designsupplier.designbase.app.AwardControllerBean");
}