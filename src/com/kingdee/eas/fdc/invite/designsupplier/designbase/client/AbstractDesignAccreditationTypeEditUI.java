 ...
 * output class name
 */
public abstract class AbstractDesignAccreditationTypeEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDesignAccreditationTypeEditUI.class);
    ...
    protected com.kingdee.eas.fdc.invite.designsupplier.designbase.DesignAccreditationTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractDesignAccreditationTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDesignAccreditationTypeEditUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(0, 0, 350, 250));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(40, 22, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(40, 57, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(544, 114, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(544, 151, 270, 19));
        this.add(kDLabelContainer4, null);
        chkisEnable.setBounds(new Rectangle(40, 223, 113, 19));
        this.add(chkisEnable, null);
        contremake.setBounds(new Rectangle(40, 87, 270, 129));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.designsupplier.designbase.app.DesignAccreditationTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.invite.designsupplier.designbase.DesignAccreditationTypeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.designsupplier.designbase.client", "DesignAccreditationTypeEditUI");
    }
