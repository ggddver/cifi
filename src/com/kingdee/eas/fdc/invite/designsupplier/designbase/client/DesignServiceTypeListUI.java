 ...
 * output class name
 */
public class DesignServiceTypeListUI extends AbstractDesignServiceTypeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DesignServiceTypeListUI.class);
    
    /**
     * output class constructor
     */
    public DesignServiceTypeListUI() throws Exception
    {
        super();
    }
	...
	protected FDCTreeBaseDataInfo getBaseDataInfo() {
		return new DesignServiceTypeInfo();
	}

	protected ITreeBase getTreeInterface() throws Exception {
		return DesignServiceTypeFactory.getRemoteInstance();
	}
