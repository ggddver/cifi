 ...
 * output class name
 */
public abstract class AbstractDesignSupplierAttachListEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDesignSupplierAttachListEditUI.class);
    ...
    protected com.kingdee.eas.fdc.invite.designsupplier.designbase.DesignSupplierAttachListInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractDesignSupplierAttachListEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDesignSupplierAttachListEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contSupplierFileType.setBounds(new Rectangle(10, 22, 270, 19));
        this.add(contSupplierFileType, null);
        contNumber.setBounds(new Rectangle(10, 73, 270, 19));
        this.add(contNumber, null);
        contName.setBounds(new Rectangle(10, 124, 270, 19));
        this.add(contName, null);
        contDescription.setBounds(new Rectangle(10, 177, 270, 85));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.designsupplier.designbase.app.DesignSupplierAttachListEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.invite.designsupplier.designbase.DesignSupplierAttachListInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.designsupplier.designbase.client", "DesignSupplierAttachListEditUI");
    }
