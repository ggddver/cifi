...
public class DesignSupplierAttachList extends FDCDataBase implements IDesignSupplierAttachList
{
    public DesignSupplierAttachList()
    {
        super();
        registerInterface(IDesignSupplierAttachList.class, this);
    }
    public DesignSupplierAttachList(Context ctx)
    {
        super(ctx);
        registerInterface(IDesignSupplierAttachList.class, this);
    }
    ...
    private DesignSupplierAttachListController getController() throws BOSException
    {
        return (DesignSupplierAttachListController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDesignSupplierAttachListInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignSupplierAttachListInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignSupplierAttachListInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignSupplierAttachListCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignSupplierAttachListCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignSupplierAttachListCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
