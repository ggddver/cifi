...
public class DesignAppraiseTemplateE1 extends CoreBillEntryBase implements IDesignAppraiseTemplateE1
{
    public DesignAppraiseTemplateE1()
    {
        super();
        registerInterface(IDesignAppraiseTemplateE1.class, this);
    }
    public DesignAppraiseTemplateE1(Context ctx)
    {
        super(ctx);
        registerInterface(IDesignAppraiseTemplateE1.class, this);
    }
    ...
    private DesignAppraiseTemplateE1Controller getController() throws BOSException
    {
        return (DesignAppraiseTemplateE1Controller)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDesignAppraiseTemplateE1Info(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignAppraiseTemplateE1Info(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignAppraiseTemplateE1Info(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignAppraiseTemplateE1Collection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignAppraiseTemplateE1Collection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignAppraiseTemplateE1Collection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
