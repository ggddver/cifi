 ...
 * output class name
 */
public class DesignPersonEditUI extends AbstractDesignPersonEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DesignPersonEditUI.class);
    
    /**
     * output class constructor
     */
    public DesignPersonEditUI() throws Exception
    {
        super();
    }
    /**
