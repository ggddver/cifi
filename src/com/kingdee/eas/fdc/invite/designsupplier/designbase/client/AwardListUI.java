 ...
 * output class name
 */
public class AwardListUI extends AbstractAwardListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AwardListUI.class);
    
    /**
     * output class constructor
     */
    public AwardListUI() throws Exception
    {
        super();
    }
