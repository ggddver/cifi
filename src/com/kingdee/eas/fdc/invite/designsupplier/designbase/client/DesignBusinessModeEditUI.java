 ...
 * output class name
 */
public class DesignBusinessModeEditUI extends AbstractDesignBusinessModeEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DesignBusinessModeEditUI.class);
    
    /**
     * output class constructor
     */
    public DesignBusinessModeEditUI() throws Exception
    {
        super();
    }
    /**
