 ...
 * output class name
 */
public class DesignServiceAreaEditUI extends AbstractDesignServiceAreaEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DesignServiceAreaEditUI.class);
    
    /**
     * output class constructor
     */
    public DesignServiceAreaEditUI() throws Exception
    {
        super();
    }
    /**
