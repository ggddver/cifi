...
public class DesignPhaseControllerBean extends AbstractDesignPhaseControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.invite.designsupplier.designbase.app.DesignPhaseControllerBean");
}