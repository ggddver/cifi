 ...
 * output class name
 */
public class DesignQuaLevelEditUI extends AbstractDesignQuaLevelEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DesignQuaLevelEditUI.class);
    
    /**
     * output class constructor
     */
    public DesignQuaLevelEditUI() throws Exception
    {
        super();
    }
    /**
