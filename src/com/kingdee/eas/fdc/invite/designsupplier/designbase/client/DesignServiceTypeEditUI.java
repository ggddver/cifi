 ...
 * output class name
 */
public class DesignServiceTypeEditUI extends AbstractDesignServiceTypeEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DesignServiceTypeEditUI.class);
    private DesignServiceTypeInfo parent = null;
     ...
     */
    public DesignServiceTypeEditUI() throws Exception
    {
        super();
    }
	...
	protected IObjectValue createNewData() {
		...
		DesignServiceTypeInfo splstInfo=new DesignServiceTypeInfo();
		Map map=getUIContext();
		DesignServiceTypeInfo info=(DesignServiceTypeInfo)map.get(UIContext.PARENTNODE);
	...
	public void initNumber()
	{
		if(parentnumber == null ){
	    	 parent = (DesignServiceTypeInfo)( getUIContext().get(UIContext.PARENTNODE));
		     if (parent == null)
		    	 return ;
	...
	public void loadFields() {
		...
		{
			parent = ((DesignServiceTypeInfo)(editData)).getParent();
			if(parent == null)
			{
				this.txtNumber.setText(((DesignServiceTypeInfo)(editData)).getNumber());
			}
			else
			{
				tempNumber = parent.getNumber();
	...
	private boolean isExist(String fkey,String fvalue) throws Exception
	{
		...
		boolean flag=DesignServiceTypeFactory.getRemoteInstance().exists(info);
		return flag;
	}
