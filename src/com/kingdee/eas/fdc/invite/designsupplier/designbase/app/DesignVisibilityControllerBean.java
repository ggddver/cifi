...
public class DesignVisibilityControllerBean extends AbstractDesignVisibilityControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.invite.designsupplier.designbase.app.DesignVisibilityControllerBean");
}