 ...
 * output class name
 */
public abstract class AbstractDesignPersonEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDesignPersonEditUI.class);
    ...
    protected com.kingdee.eas.fdc.invite.designsupplier.designbase.DesignPersonInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractDesignPersonEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDesignPersonEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.designsupplier.designbase.app.DesignPersonEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.invite.designsupplier.designbase.DesignPersonInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.designsupplier.designbase.client", "DesignPersonEditUI");
    }
