 ...
 * output class name
 */
public class DesignAppraiseTemplateListUI extends AbstractDesignAppraiseTemplateListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DesignAppraiseTemplateListUI.class);
    
    /**
     * output class constructor
     */
    public DesignAppraiseTemplateListUI() throws Exception
    {
        super();
    }
    ...
    public void actionAddNew_actionPerformed(ActionEvent e) throws Exception {
    	...
    	if(getTypeSelectedTreeNode().getUserObject() instanceof DesignAppraiseTemplateTreeInfo&&((DesignAppraiseTemplateTreeInfo)getTypeSelectedTreeNode().getUserObject()).isIsLeaf()){
			getUIContext().put("group", ((DesignAppraiseTemplateTreeInfo)getTypeSelectedTreeNode().getUserObject()));
    ...
    public void actionAudit_actionPerformed(ActionEvent e) throws Exception {
    	...
    	DesignAppraiseTemplateInfo info = DesignAppraiseTemplateFactory.getRemoteInstance().getDesignAppraiseTemplateInfo(new ObjectUuidPK(id));
    	info.setState(FDCBillStateEnum.AUDITTED);
    	info.setAuditDate(SysUtil.getAppServerTime(null));
    	info.setAuditPerson(getUserInfo());
    	DesignAppraiseTemplateFactory.getRemoteInstance().update(new ObjectUuidPK(info.getId()), info);
    	this.refresh(e);
    }
...
//        super.tblMain_tableSelectChanged(e);
    ...
    {
        return com.kingdee.eas.fdc.invite.designsupplier.designbase.client.DesignAppraiseTemplateTreeEditUI.class.getName();
    }
