 ...
 * output class name
 */
public class DesignPhaseEditUI extends AbstractDesignPhaseEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DesignPhaseEditUI.class);
    
    /**
     * output class constructor
     */
    public DesignPhaseEditUI() throws Exception
    {
        super();
    }
    /**
