...
public class DesignServiceTypeControllerBean extends AbstractDesignServiceTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.invite.designsupplier.designbase.app.DesignServiceTypeControllerBean");
}