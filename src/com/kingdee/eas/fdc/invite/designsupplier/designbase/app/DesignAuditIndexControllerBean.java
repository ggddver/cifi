...
public class DesignAuditIndexControllerBean extends AbstractDesignAuditIndexControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.invite.designsupplier.designbase.app.DesignAuditIndexControllerBean");
}