 ...
 * output class name
 */
public class DesSupplierFileTypeEditUI extends AbstractDesSupplierFileTypeEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DesSupplierFileTypeEditUI.class);
    
    /**
     * output class constructor
     */
    public DesSupplierFileTypeEditUI() throws Exception
    {
        super();
    }
    /**
