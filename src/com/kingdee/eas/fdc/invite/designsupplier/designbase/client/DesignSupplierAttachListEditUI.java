 ...
 * output class name
 */
public class DesignSupplierAttachListEditUI extends AbstractDesignSupplierAttachListEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DesignSupplierAttachListEditUI.class);
    
    /**
     * output class constructor
     */
    public DesignSupplierAttachListEditUI() throws Exception
    {
        super();
    }
    /**
    ...
    protected com.kingdee.bos.dao.IObjectValue createNewData()
    {
        ...
        objectValue.setSupplierFileType((DesSupplierFileTypeInfo)this.getUIContext().get("supplierFileType"));
        return objectValue;
    }
