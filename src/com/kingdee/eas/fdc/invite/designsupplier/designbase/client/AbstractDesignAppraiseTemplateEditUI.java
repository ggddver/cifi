 ...
 * output class name
 */
public abstract class AbstractDesignAppraiseTemplateEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDesignAppraiseTemplateEditUI.class);
    ...
    protected com.kingdee.eas.fdc.invite.designsupplier.designbase.DesignAppraiseTemplateInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractDesignAppraiseTemplateEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDesignAppraiseTemplateEditUI.class.getName());
        ...
        kdtE1_IndexName_PromptBox.setQueryInfo("com.kingdee.eas.fdc.invite.designsupplier.designbase.app.DesignAuditIndexQuery");
        ...
        this.kdtE1.getColumn("IndexName").setRenderer(kdtE1_IndexName_OVR);
			...
			com.kingdee.eas.fdc.invite.designsupplier.designbase.client.DesignAuditIndexListUI kdtE1_IndexName_PromptBox_F7ListUI = null;
			public void willShow(SelectorEvent e) {
				if (kdtE1_IndexName_PromptBox_F7ListUI == null) {
					try {
						kdtE1_IndexName_PromptBox_F7ListUI = new com.kingdee.eas.fdc.invite.designsupplier.designbase.client.DesignAuditIndexListUI();
					} catch (Exception e1) {
						e1.printStackTrace();
					}
    ...
    public void initUIContentLayout()
    {
        ...
        kdtE1_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtE1,new com.kingdee.eas.fdc.invite.designsupplier.designbase.DesignAppraiseTemplateE1Info(),null,false);
...
vo.put("ScoreType","WEIGHT");
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("E1", com.kingdee.eas.fdc.invite.designsupplier.designbase.DesignAppraiseTemplateE1Info.class, this.kdtE1, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.designsupplier.designbase.app.DesignAppraiseTemplateEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.invite.designsupplier.designbase.DesignAppraiseTemplateInfo)ov;
    }
...
//        sic.add(new SelectorItemInfo("E1.IndexName.number"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.designsupplier.designbase.client", "DesignAppraiseTemplateEditUI");
    }
