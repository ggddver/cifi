...
public interface DesignSupplierStockController extends FDCDataBaseController
{
    public DesignSupplierStockInfo getDesignSupplierStockInfo(Context ctx, IObjectPK pk) throws BOSException, EASBizException, RemoteException;
    public DesignSupplierStockInfo getDesignSupplierStockInfo(Context ctx, IObjectPK pk, SelectorItemCollection selector) throws BOSException, EASBizException, RemoteException;
    public DesignSupplierStockInfo getDesignSupplierStockInfo(Context ctx, String oql) throws BOSException, EASBizException, RemoteException;
    public DesignSupplierStockCollection getDesignSupplierStockCollection(Context ctx) throws BOSException, RemoteException;
    public DesignSupplierStockCollection getDesignSupplierStockCollection(Context ctx, EntityViewInfo view) throws BOSException, RemoteException;
    public DesignSupplierStockCollection getDesignSupplierStockCollection(Context ctx, String oql) throws BOSException, RemoteException;
    ...
    public DesignSupplierStockCollection getSupplierDataBase(Context ctx, String supLongNumber) throws BOSException, EASBizException, RemoteException;
    ...
    public DesignSupplierStockCollection getSericeArea(Context ctx) throws BOSException, EASBizException, RemoteException;
    ...
    public void updateHisCount(Context ctx, IObjectPK pk, boolean isAudit) throws BOSException, EASBizException, RemoteException;
    public void beachUpdateHisCount(Context ctx, IObjectPK[] pks, boolean isAudit) throws BOSException, EASBizException, RemoteException;
