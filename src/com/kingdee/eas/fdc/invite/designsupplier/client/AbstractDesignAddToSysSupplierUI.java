 ...
 * output class name
 */
public abstract class AbstractDesignAddToSysSupplierUI extends com.kingdee.eas.fdc.invite.supplier.client.AddToSysSupplierUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDesignAddToSysSupplierUI.class);
    /**
     * output class constructor
     */
    public AbstractDesignAddToSysSupplierUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDesignAddToSysSupplierUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.designsupplier.app.DesignAddToSysSupplierUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.designsupplier.client", "DesignAddToSysSupplierUI");
    }
