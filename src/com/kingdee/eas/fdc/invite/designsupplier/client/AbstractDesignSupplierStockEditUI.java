 ...
 * output class name
 */
public abstract class AbstractDesignSupplierStockEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDesignSupplierStockEditUI.class);
    protected com.kingdee.bos.ctrl.swing.KDScrollPane kDScrollPane3;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contpodutId;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contDesignJD;
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contcompanyScale;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contexpertise;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contcooperation;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contgatadeLv;
    ...
    protected com.kingdee.bos.ctrl.swing.KDScrollPane scrollPanecompanyScale;
    protected com.kingdee.bos.ctrl.swing.KDTextArea txtcompanyScale;
    protected com.kingdee.bos.ctrl.swing.KDScrollPane scrollPaneexpertise;
    protected com.kingdee.bos.ctrl.swing.KDTextArea txtexpertise;
    protected com.kingdee.bos.ctrl.swing.KDScrollPane scrollPanecooperation;
    protected com.kingdee.bos.ctrl.swing.KDTextArea txtcooperation;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtgatadeLv;
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contdesignPhase;
    ...
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtdesignPhase;
    ...
    protected com.kingdee.bos.ctrl.swing.KDScrollPane scrollPanepodutId;
    protected com.kingdee.bos.ctrl.swing.KDTextArea txtpodutId;
    protected com.kingdee.bos.ctrl.swing.KDScrollPane scrollPaneDesignJD;
    protected com.kingdee.bos.ctrl.swing.KDTextArea txtDesignJD;
    protected com.kingdee.eas.fdc.invite.designsupplier.DesignSupplierStockInfo editData = null;
     ...
     */
    public AbstractDesignSupplierStockEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDesignSupplierStockEditUI.class.getName());
        ...
        this.contpodutId = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contDesignJD = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.contcompanyScale = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contexpertise = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contcooperation = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contgatadeLv = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.scrollPanecompanyScale = new com.kingdee.bos.ctrl.swing.KDScrollPane();
        this.txtcompanyScale = new com.kingdee.bos.ctrl.swing.KDTextArea();
        this.scrollPaneexpertise = new com.kingdee.bos.ctrl.swing.KDScrollPane();
        this.txtexpertise = new com.kingdee.bos.ctrl.swing.KDTextArea();
        this.scrollPanecooperation = new com.kingdee.bos.ctrl.swing.KDScrollPane();
        this.txtcooperation = new com.kingdee.bos.ctrl.swing.KDTextArea();
        this.prmtgatadeLv = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        ...
        this.contdesignPhase = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.prmtdesignPhase = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        ...
        this.scrollPanepodutId = new com.kingdee.bos.ctrl.swing.KDScrollPane();
        this.txtpodutId = new com.kingdee.bos.ctrl.swing.KDTextArea();
        this.scrollPaneDesignJD = new com.kingdee.bos.ctrl.swing.KDScrollPane();
        this.txtDesignJD = new com.kingdee.bos.ctrl.swing.KDTextArea();
        this.kDScrollPane3.setName("kDScrollPane3");
        this.contpodutId.setName("contpodutId");
        this.contDesignJD.setName("contDesignJD");
        ...
        this.contcompanyScale.setName("contcompanyScale");
        this.contexpertise.setName("contexpertise");
        this.contcooperation.setName("contcooperation");
        this.contgatadeLv.setName("contgatadeLv");
        ...
        this.scrollPanecompanyScale.setName("scrollPanecompanyScale");
        this.txtcompanyScale.setName("txtcompanyScale");
        this.scrollPaneexpertise.setName("scrollPaneexpertise");
        this.txtexpertise.setName("txtexpertise");
        this.scrollPanecooperation.setName("scrollPanecooperation");
        this.txtcooperation.setName("txtcooperation");
        this.prmtgatadeLv.setName("prmtgatadeLv");
        ...
        this.contdesignPhase.setName("contdesignPhase");
        ...
        this.prmtdesignPhase.setName("prmtdesignPhase");
        ...
        this.scrollPanepodutId.setName("scrollPanepodutId");
        this.txtpodutId.setName("txtpodutId");
        this.scrollPaneDesignJD.setName("scrollPaneDesignJD");
        this.txtDesignJD.setName("txtDesignJD");
        // CoreUI		
        ...
        // contpodutId		
        this.contpodutId.setBoundLabelText(resHelper.getString("contpodutId.boundLabelText"));		
        this.contpodutId.setBoundLabelLength(100);		
        this.contpodutId.setBoundLabelUnderline(true);		
        this.contpodutId.setVisible(true);
        // contDesignJD		
        this.contDesignJD.setBoundLabelText(resHelper.getString("contDesignJD.boundLabelText"));		
        this.contDesignJD.setBoundLabelLength(100);		
        this.contDesignJD.setBoundLabelUnderline(true);		
        this.contDesignJD.setVisible(true);
        // kDTabbedPane1		
        this.kDTabbedPane1.setPreferredSize(new Dimension(1013,1000));		
        this.kDTabbedPane1.setMinimumSize(new Dimension(1013,1000));
        // panelBase		
        ...
        // contcompanyScale		
        this.contcompanyScale.setBoundLabelText(resHelper.getString("contcompanyScale.boundLabelText"));		
        this.contcompanyScale.setBoundLabelLength(18);		
        this.contcompanyScale.setBoundLabelUnderline(true);		
        this.contcompanyScale.setVisible(true);		
        this.contcompanyScale.setBoundLabelAlignment(8);
        // contexpertise		
        this.contexpertise.setBoundLabelText(resHelper.getString("contexpertise.boundLabelText"));		
        this.contexpertise.setBoundLabelLength(18);		
        this.contexpertise.setBoundLabelUnderline(true);		
        this.contexpertise.setVisible(true);		
        this.contexpertise.setBoundLabelAlignment(8);
        // contcooperation		
        this.contcooperation.setBoundLabelText(resHelper.getString("contcooperation.boundLabelText"));		
        this.contcooperation.setBoundLabelLength(18);		
        this.contcooperation.setBoundLabelUnderline(true);		
        this.contcooperation.setVisible(true);		
        this.contcooperation.setBoundLabelAlignment(8);
        // contgatadeLv		
        this.contgatadeLv.setBoundLabelText(resHelper.getString("contgatadeLv.boundLabelText"));		
        this.contgatadeLv.setBoundLabelLength(100);		
        this.contgatadeLv.setBoundLabelUnderline(true);		
        this.contgatadeLv.setVisible(true);
        // txtNumber		
        ...
        this.cbIsPass.addItems(EnumUtils.getEnumList("com.kingdee.eas.fdc.invite.designsupplier.designbase.ResultsEnum").toArray());
        // prmtInviteType		
        ...
        // scrollPanecompanyScale
        // txtcompanyScale		
        this.txtcompanyScale.setVisible(true);		
        this.txtcompanyScale.setRequired(false);		
        this.txtcompanyScale.setMaxLength(500);
        // scrollPaneexpertise
        // txtexpertise		
        this.txtexpertise.setVisible(true);		
        this.txtexpertise.setRequired(false);		
        this.txtexpertise.setMaxLength(500);
        // scrollPanecooperation
        // txtcooperation		
        this.txtcooperation.setVisible(true);		
        this.txtcooperation.setRequired(false);		
        this.txtcooperation.setMaxLength(255);
        // prmtgatadeLv		
        this.prmtgatadeLv.setQueryInfo("com.kingdee.eas.fdc.invite.designsupplier.designbase.app.DesignGradeSetUpQuery");		
        this.prmtgatadeLv.setVisible(true);		
        this.prmtgatadeLv.setEditable(true);		
        this.prmtgatadeLv.setDisplayFormat("$name$");		
        this.prmtgatadeLv.setEditFormat("$number$");		
        this.prmtgatadeLv.setCommitFormat("$number$");		
        this.prmtgatadeLv.setRequired(false);
        ...
        // contdesignPhase		
        this.contdesignPhase.setBoundLabelText(resHelper.getString("contdesignPhase.boundLabelText"));		
        this.contdesignPhase.setBoundLabelLength(100);		
        this.contdesignPhase.setBoundLabelUnderline(true);		
        this.contdesignPhase.setVisible(true);
        // contproductType		
        ...
        // kDTextField1
        // prmtdesignPhase		
        this.prmtdesignPhase.setQueryInfo("com.kingdee.eas.fdc.invite.designsupplier.designbase.app.DesignPhaseQuery");		
        this.prmtdesignPhase.setVisible(true);		
        this.prmtdesignPhase.setEditable(true);		
        this.prmtdesignPhase.setDisplayFormat("$name$");		
        this.prmtdesignPhase.setEditFormat("$number$");		
        this.prmtdesignPhase.setCommitFormat("$number$");		
        this.prmtdesignPhase.setRequired(false);		
        this.prmtdesignPhase.setEnabledMultiSelection(true);
        // prmtproductType		
        this.prmtproductType.setQueryInfo("com.kingdee.eas.fdc.invite.designsupplier.designbase.app.ProductTypeQuery");		
        ...
        // kdtLinkPerson
		String kdtLinkPersonStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol7\"><c:Protection hidden=\"true\" /></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"personName\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"true\" t:index=\"-1\" t:configured=\"false\" /><t:Column t:key=\"position\" t:width=\"150\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:configured=\"false\" /><t:Column t:key=\"phone\" t:width=\"150\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"true\" t:index=\"-1\" t:configured=\"false\" /><t:Column t:key=\"workPhone\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:configured=\"false\" /><t:Column t:key=\"personFax\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:configured=\"false\" /><t:Column t:key=\"isDefault\" t:width=\"150\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:configured=\"false\" /><t:Column t:key=\"email\" t:width=\"150\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:configured=\"false\" /><t:Column t:key=\"contact\" t:width=\"200\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:configured=\"false\" t:styleID=\"sCol7\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:configured=\"false\"><t:Cell t:configured=\"false\">姓名</t:Cell><t:Cell t:configured=\"false\">职务</t:Cell><t:Cell t:configured=\"false\">手机</t:Cell><t:Cell t:configured=\"false\">办公电话</t:Cell><t:Cell t:configured=\"false\">传真</t:Cell><t:Cell t:configured=\"false\">是否为授权联系人</t:Cell><t:Cell t:configured=\"false\">邮箱</t:Cell><t:Cell t:configured=\"false\">联系方式</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
		...
		String kdtSupplierAttachListStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles /><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"number\" t:width=\"150\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:configured=\"false\" /><t:Column t:key=\"name\" t:width=\"250\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:configured=\"false\" /><t:Column t:key=\"attachment\" t:width=\"300\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:configured=\"false\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:configured=\"false\"><t:Cell t:configured=\"false\">类别编码</t:Cell><t:Cell t:configured=\"false\">类别名称</t:Cell><t:Cell t:configured=\"false\">附件列表</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
        ...
        // kdtProject
		String kdtProjectStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol0\"><c:NumberFormat>&amp;int</c:NumberFormat></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"seq\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:configured=\"false\" t:styleID=\"sCol0\" /><t:Column t:key=\"projectName\" t:width=\"600\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:configured=\"false\" /><t:Column t:key=\"awld\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:configured=\"false\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:configured=\"false\"><t:Cell t:configured=\"false\">单据分录序列号</t:Cell><t:Cell t:configured=\"false\">代表项目（简介）</t:Cell><t:Cell t:configured=\"false\">所获奖项</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
		
        this.kdtProject.setFormatXml(resHelper.translateString("kdtProject",kdtProjectStrXML));

                this.kdtProject.putBindContents("editData",new String[] {"seq","projectName","awld"});


        this.kdtProject.checkParsed();
        KDTextField kdtProject_projectName_TextField = new KDTextField();
        kdtProject_projectName_TextField.setName("kdtProject_projectName_TextField");
        kdtProject_projectName_TextField.setMaxLength(500);
        KDTDefaultCellEditor kdtProject_projectName_CellEditor = new KDTDefaultCellEditor(kdtProject_projectName_TextField);
        this.kdtProject.getColumn("projectName").setEditor(kdtProject_projectName_CellEditor);
        KDTextField kdtProject_awld_TextField = new KDTextField();
        kdtProject_awld_TextField.setName("kdtProject_awld_TextField");
        kdtProject_awld_TextField.setMaxLength(500);
        KDTDefaultCellEditor kdtProject_awld_CellEditor = new KDTDefaultCellEditor(kdtProject_awld_TextField);
        this.kdtProject.getColumn("awld").setEditor(kdtProject_awld_CellEditor);
        // kdtSupplierPerson
		String kdtSupplierPersonStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles /><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"position\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"0\" t:configured=\"false\" /><t:Column t:key=\"name\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"1\" t:configured=\"false\" /><t:Column t:key=\"linkType\" t:width=\"200\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"2\" t:configured=\"false\" /><t:Column t:key=\"resume\" t:width=\"200\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"3\" t:configured=\"false\" /><t:Column t:key=\"occupationLevel\" t:width=\"150\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"4\" t:configured=\"false\" /><t:Column t:key=\"projectName\" t:width=\"300\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"5\" t:configured=\"false\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:configured=\"false\"><t:Cell t:configured=\"false\">职位</t:Cell><t:Cell t:configured=\"false\">名称</t:Cell><t:Cell t:configured=\"false\">联系方式</t:Cell><t:Cell t:configured=\"false\">简历</t:Cell><t:Cell t:configured=\"false\">职业资质</t:Cell><t:Cell t:configured=\"false\">代表项目</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
        ...
        // scrollPanepodutId
        // txtpodutId		
        this.txtpodutId.setVisible(true);		
        this.txtpodutId.setRequired(false);		
        this.txtpodutId.setMaxLength(1000);
        // scrollPaneDesignJD
        // txtDesignJD		
        this.txtDesignJD.setVisible(true);		
        this.txtDesignJD.setRequired(false);		
        this.txtDesignJD.setMaxLength(1000);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {kdtProject,pkCreateTime,prmtCreator,kDTextField1,txtNumber,txtName,txtcooperation,txtexpertise,txtcompanyScale,txtmarketRemake,txtserverfees,prmtVisibility,prmtQuaLevel,txtRecommended,prmtPurchaseOrgUnit,prmtInviteType,pkAuditDate,prmtAuditor,txtScale,txtAbility,txtLastYearProfit,txtCurrentLiabilities,txtLongLiabilities,txtTotalLiabilities,txtCurrentAssets,txtFixedAssets,txtTotalAssets,prmtSupplierBusinessMode,prmtSupplierFileType,txtBizRegisterNo,txtTaxRegisterNo,pkStorageDate,txtStorageNumber,cbIsPass,prmtCity,prmtProvince,txtPostNumber,comboCurrency,txtMainWork,txtAddress,txtLinkMail,txtLinkFax,txtLinkPhone,txtPeopleCount,txtBusinessNum,txtWebSite,txtRegisterMoney,pkBuildDate,txtEnterpriseMaster,comboEnterpriseKind,txtDesignJD,txtpodutId,prmtproductType,prmtdesignPhase}));
    ...
    {
        this.setBounds(new Rectangle(10, 10, 1013, 1000));
        this.setLayout(new KDLayout());
        this.putClientProperty("OriginalBounds", new Rectangle(10, 10, 1013, 1000));
        kDScrollPane3.setBounds(new Rectangle(0, 0, 1013, 1000));
        this.add(kDScrollPane3, new KDLayout.Constraints(0, 0, 1013, 1000, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contpodutId.setBounds(new Rectangle(662, 923, 270, 19));
        this.add(contpodutId, new KDLayout.Constraints(662, 923, 270, 19, 0));
        contDesignJD.setBounds(new Rectangle(716, 943, 270, 19));
        this.add(contDesignJD, new KDLayout.Constraints(716, 943, 270, 19, 0));
        //kDScrollPane3
        ...
        panelBase.putClientProperty("OriginalBounds", new Rectangle(0, 0, 1012, 967));        kDPanel1.setBounds(new Rectangle(0, -1, 1013, 236));
        panelBase.add(kDPanel1, new KDLayout.Constraints(0, -1, 1013, 236, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        kDPanel2.setBounds(new Rectangle(0, 237, 1013, 215));
        panelBase.add(kDPanel2, new KDLayout.Constraints(0, 237, 1013, 215, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contCreator.setBounds(new Rectangle(2, 920, 270, 19));
        panelBase.add(contCreator, new KDLayout.Constraints(2, 920, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAuditor.setBounds(new Rectangle(2, 942, 270, 19));
        panelBase.add(contAuditor, new KDLayout.Constraints(2, 942, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCreateTime.setBounds(new Rectangle(368, 920, 270, 19));
        panelBase.add(contCreateTime, new KDLayout.Constraints(368, 920, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAuditDate.setBounds(new Rectangle(368, 942, 270, 19));
        panelBase.add(contAuditDate, new KDLayout.Constraints(368, 942, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDPanel3.setBounds(new Rectangle(901, 715, 18, 20));
        panelBase.add(kDPanel3, new KDLayout.Constraints(901, 715, 18, 20, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        kDPanel4.setBounds(new Rectangle(0, 743, 1013, 171));
        panelBase.add(kDPanel4, new KDLayout.Constraints(0, 743, 1013, 171, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        kDPanel5.setBounds(new Rectangle(0, 454, 1013, 289));
        panelBase.add(kDPanel5, new KDLayout.Constraints(0, 454, 1013, 289, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contServiceType.setBounds(new Rectangle(586, 626, 270, 19));
        panelBase.add(contServiceType, new KDLayout.Constraints(586, 626, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contTaxRegisterNo.setBounds(new Rectangle(941, 626, 270, 19));
        panelBase.add(contTaxRegisterNo, new KDLayout.Constraints(941, 626, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contBizRegisterNo.setBounds(new Rectangle(1296, 626, 270, 19));
        panelBase.add(contBizRegisterNo, new KDLayout.Constraints(1296, 626, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contSupplierBusinessMode.setBounds(new Rectangle(1296, 648, 270, 19));
        panelBase.add(contSupplierBusinessMode, new KDLayout.Constraints(1296, 648, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contSupplierFileType.setBounds(new Rectangle(941, 648, 270, 19));
        panelBase.add(contSupplierFileType, new KDLayout.Constraints(941, 648, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //kDPanel1
        kDPanel1.setLayout(new KDLayout());
        kDPanel1.putClientProperty("OriginalBounds", new Rectangle(0, -1, 1013, 236));        contNumber.setBounds(new Rectangle(15, 15, 270, 19));
        ...
        contPostNumber.setBounds(new Rectangle(648, 99, 9, 19));
        kDPanel1.add(contPostNumber, new KDLayout.Constraints(648, 99, 9, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contWebSite.setBounds(new Rectangle(15, 81, 270, 19));
        kDPanel1.add(contWebSite, new KDLayout.Constraints(15, 81, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer1.setBounds(new Rectangle(281, 34, 270, 19));
        kDPanel1.add(kDLabelContainer1, new KDLayout.Constraints(281, 34, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contIsPass.setBounds(new Rectangle(725, 103, 270, 19));
        kDPanel1.add(contIsPass, new KDLayout.Constraints(725, 103, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contRecommended.setBounds(new Rectangle(648, 35, 8, 19));
        kDPanel1.add(contRecommended, new KDLayout.Constraints(648, 35, 8, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contQuaLevel.setBounds(new Rectangle(370, 81, 270, 19));
        kDPanel1.add(contQuaLevel, new KDLayout.Constraints(370, 81, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contVisibility.setBounds(new Rectangle(648, 56, 8, 19));
        kDPanel1.add(contVisibility, new KDLayout.Constraints(648, 56, 8, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contmarketRemake.setBounds(new Rectangle(264, 124, 234, 99));
        kDPanel1.add(contmarketRemake, new KDLayout.Constraints(264, 124, 234, 99, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contserverfees.setBounds(new Rectangle(648, 77, 10, 19));
        kDPanel1.add(contserverfees, new KDLayout.Constraints(648, 77, 10, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contcompanyScale.setBounds(new Rectangle(16, 124, 234, 99));
        kDPanel1.add(contcompanyScale, new KDLayout.Constraints(16, 124, 234, 99, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contexpertise.setBounds(new Rectangle(512, 124, 234, 99));
        kDPanel1.add(contexpertise, new KDLayout.Constraints(512, 124, 234, 99, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contcooperation.setBounds(new Rectangle(762, 124, 234, 99));
        kDPanel1.add(contcooperation, new KDLayout.Constraints(762, 124, 234, 99, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contgatadeLv.setBounds(new Rectangle(15, 103, 270, 19));
        kDPanel1.add(contgatadeLv, new KDLayout.Constraints(15, 103, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contNumber
        ...
        //contcompanyScale
        contcompanyScale.setBoundEditor(scrollPanecompanyScale);
        //scrollPanecompanyScale
        scrollPanecompanyScale.getViewport().add(txtcompanyScale, null);
        //contexpertise
        contexpertise.setBoundEditor(scrollPaneexpertise);
        //scrollPaneexpertise
        scrollPaneexpertise.getViewport().add(txtexpertise, null);
        //contcooperation
        contcooperation.setBoundEditor(scrollPanecooperation);
        //scrollPanecooperation
        scrollPanecooperation.getViewport().add(txtcooperation, null);
        //contgatadeLv
        contgatadeLv.setBoundEditor(prmtgatadeLv);
        //kDPanel2
        kDPanel2.setLayout(new KDLayout());
        kDPanel2.putClientProperty("OriginalBounds", new Rectangle(0, 237, 1013, 215));        contEnterpriseMaster.setBounds(new Rectangle(15, 15, 270, 19));
        ...
        contRegisterMoney.setBounds(new Rectangle(818, 51, 163, 19));
        kDPanel2.add(contRegisterMoney, new KDLayout.Constraints(818, 51, 163, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCurrency.setBounds(new Rectangle(995, 51, 93, 18));
        kDPanel2.add(contCurrency, new KDLayout.Constraints(995, 51, 93, 18, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contSupplierSplAreaEntry.setBounds(new Rectangle(15, 37, 270, 19));
        kDPanel2.add(contSupplierSplAreaEntry, new KDLayout.Constraints(15, 37, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer2.setBounds(new Rectangle(15, 60, 270, 19));
        kDPanel2.add(kDLabelContainer2, new KDLayout.Constraints(15, 60, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contdesignPhase.setBounds(new Rectangle(370, 60, 270, 19));
        kDPanel2.add(contdesignPhase, new KDLayout.Constraints(370, 60, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contproductType.setBounds(new Rectangle(725, 60, 270, 19));
        kDPanel2.add(contproductType, new KDLayout.Constraints(725, 60, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contLinkPerson.setBounds(new Rectangle(15, 80, 980, 122));
        kDPanel2.add(contLinkPerson, new KDLayout.Constraints(15, 80, 980, 122, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //contEnterpriseMaster
        ...
        //contdesignPhase
        contdesignPhase.setBoundEditor(prmtdesignPhase);
        //contproductType
...
contLinkPerson.getContentPane().setLayout(new BorderLayout(0, 0));        contLinkPerson.getContentPane().add(kdtLinkPerson, BorderLayout.CENTER);
        ...
        kDPanel3.putClientProperty("OriginalBounds", new Rectangle(901, 715, 18, 20));        contTotalAssets.setBounds(new Rectangle(15, 15, 270, 19));
        ...
        kDPanel4.putClientProperty("OriginalBounds", new Rectangle(0, 743, 1013, 171));        contSupplierAttachList.setBounds(new Rectangle(15, 17, 980, 140));
        kDPanel4.add(contSupplierAttachList, new KDLayout.Constraints(15, 17, 980, 140, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //contSupplierAttachList
contSupplierAttachList.getContentPane().setLayout(new BorderLayout(0, 0));        contSupplierAttachList.getContentPane().add(kdtSupplierAttachList, BorderLayout.CENTER);
        ...
        kDPanel5.putClientProperty("OriginalBounds", new Rectangle(0, 454, 1013, 289));        kDContainer1.setBounds(new Rectangle(15, 17, 980, 127));
        kDPanel5.add(kDContainer1, new KDLayout.Constraints(15, 17, 980, 127, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        kDContainer2.setBounds(new Rectangle(15, 144, 980, 132));
        kDPanel5.add(kDContainer2, new KDLayout.Constraints(15, 144, 980, 132, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDContainer1
kDContainer1.getContentPane().setLayout(new BorderLayout(0, 0));        kdtProject_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtProject,new com.kingdee.eas.fdc.invite.designsupplier.DesignSupplierStockProjectInfo(),null,false);
        kDContainer1.getContentPane().add(kdtProject_detailPanel, BorderLayout.CENTER);
        //kDContainer2
kDContainer2.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainer2.getContentPane().add(kdtSupplierPerson, BorderLayout.CENTER);
        //contServiceType
        ...
        panelBill.putClientProperty("OriginalBounds", new Rectangle(0, 0, 1012, 967));        kDTabbedPane2.setBounds(new Rectangle(0, 0, 1013, 600));
        ...
        //contpodutId
        contpodutId.setBoundEditor(scrollPanepodutId);
        //scrollPanepodutId
        scrollPanepodutId.getViewport().add(txtpodutId, null);
        //contDesignJD
        contDesignJD.setBoundEditor(scrollPaneDesignJD);
        //scrollPaneDesignJD
        scrollPaneDesignJD.getViewport().add(txtDesignJD, null);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("companyScale", String.class, this.txtcompanyScale, "text");
		dataBinder.registerBinding("expertise", String.class, this.txtexpertise, "text");
		dataBinder.registerBinding("cooperation", String.class, this.txtcooperation, "text");
		dataBinder.registerBinding("gatadeLv", com.kingdee.eas.fdc.invite.designsupplier.designbase.DesignGradeSetUpInfo.class, this.prmtgatadeLv, "data");
		...
		dataBinder.registerBinding("Project", com.kingdee.eas.fdc.invite.designsupplier.DesignSupplierStockProjectInfo.class, this.kdtProject, "userObject");
		dataBinder.registerBinding("Project.projectName", String.class, this.kdtProject, "projectName.text");
		dataBinder.registerBinding("Project.awld", String.class, this.kdtProject, "awld.text");
		...
		dataBinder.registerBinding("podutId", String.class, this.txtpodutId, "text");
		dataBinder.registerBinding("DesignJD", String.class, this.txtDesignJD, "text");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.designsupplier.app.DesignSupplierStockEditUIHandler";
	}
    ...
    {
        super.onShow();
        this.kdtProject.requestFocusInWindow();
    }
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.invite.designsupplier.DesignSupplierStockInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("companyScale", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("expertise", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("cooperation", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("gatadeLv", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("Project.projectName", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("Project.awld", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("podutId", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("DesignJD", ValidateHelper.ON_SAVE);    		
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("companyScale"));
        sic.add(new SelectorItemInfo("expertise"));
        sic.add(new SelectorItemInfo("cooperation"));
        sic.add(new SelectorItemInfo("gatadeLv.*"));
...
//        sic.add(new SelectorItemInfo("Project.number"));
    ...
    sic.add(new SelectorItemInfo("Project.awld"));
        ...
        sic.add(new SelectorItemInfo("podutId"));
        sic.add(new SelectorItemInfo("DesignJD"));
        return sic;
    }        
    ...
    protected class ActionPersonAddLine extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractDesignSupplierStockEditUI.this, "ActionPersonAddLine", "actionPersonAddLine_actionPerformed", e);
        }
    }
    ...
    protected class ActionPersonInsertLine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDesignSupplierStockEditUI.this, "ActionPersonInsertLine", "actionPersonInsertLine_actionPerformed", e);
        }
    }
    ...
    protected class ActionPersonRemoveLine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDesignSupplierStockEditUI.this, "ActionPersonRemoveLine", "actionPersonRemoveLine_actionPerformed", e);
        }
    }
    ...
    protected class ActionLinkPersonRemoveLine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDesignSupplierStockEditUI.this, "ActionLinkPersonRemoveLine", "actionLinkPersonRemoveLine_actionPerformed", e);
        }
    }
    ...
    protected class ActionLinkPersonAddLine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDesignSupplierStockEditUI.this, "ActionLinkPersonAddLine", "actionLinkPersonAddLine_actionPerformed", e);
        }
    }
    ...
    protected class ActionLinkPersonInsertLine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDesignSupplierStockEditUI.this, "ActionLinkPersonInsertLine", "actionLinkPersonInsertLine_actionPerformed", e);
        }
    }
    ...
    protected class ActionAttachListAddLine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDesignSupplierStockEditUI.this, "ActionAttachListAddLine", "actionAttachListAddLine_actionPerformed", e);
        }
    }
    ...
    protected class ActionAttachListRemoveLine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDesignSupplierStockEditUI.this, "ActionAttachListRemoveLine", "actionAttachListRemoveLine_actionPerformed", e);
        }
    }
    ...
    protected class ActionAttachListInsertLine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDesignSupplierStockEditUI.this, "ActionAttachListInsertLine", "actionAttachListInsertLine_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.designsupplier.client", "DesignSupplierStockEditUI");
    }
    ...
    {
        return com.kingdee.eas.fdc.invite.designsupplier.client.DesignSupplierStockEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/fdc/invite/designsupplier/DesignSupplierStock";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.fdc.invite.designsupplier.app.DesignSupplierStockQuery");
	}
