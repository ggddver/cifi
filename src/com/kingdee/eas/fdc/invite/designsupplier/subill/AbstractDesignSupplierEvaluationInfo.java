...
public class AbstractDesignSupplierEvaluationInfo extends com.kingdee.eas.framework.CoreBillBaseInfo implements Serializable 
{
    public AbstractDesignSupplierEvaluationInfo()
    {
        this("id");
    }
    protected AbstractDesignSupplierEvaluationInfo(String pkField)
    {
        super(pkField);
        put("entrys", new com.kingdee.eas.fdc.invite.designsupplier.subill.DesignSupplierEvaluationEntryCollection());
    }
    /**
     * Object: 供应商评定 's 分录 property 
     */
    public com.kingdee.eas.fdc.invite.designsupplier.subill.DesignSupplierEvaluationEntryCollection getEntrys()
    {
        return (com.kingdee.eas.fdc.invite.designsupplier.subill.DesignSupplierEvaluationEntryCollection)get("entrys");
    }
    /**
     * Object:供应商评定's 是否生成凭证property 
     */
    ...
    /**
     * Object:供应商评定's 授权联系人电话property 
     */
