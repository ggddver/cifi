 ...
 * output class name
 */
public abstract class AbstractDesignSupplierSelectListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDesignSupplierSelectListUI.class);
     ...
     */
    public AbstractDesignSupplierSelectListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDesignSupplierSelectListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.invite.designsupplier.subill.app", "DesignSupplierSelectQuery");
        //actionRemove
    ...
    public void initUIContentLayout()
    {
        ...
        kDSplitPane1.setBounds(new Rectangle(3, 2, 1010, 625));
        this.add(kDSplitPane1, new KDLayout.Constraints(3, 2, 1010, 625, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDSplitPane1
        ...
        //kDContainer2
kDContainer2.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainer2.getContentPane().add(orgTree, BorderLayout.CENTER);
        //kDContainer3
kDContainer3.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainer3.getContentPane().add(supplierTypeTree, BorderLayout.CENTER);
        //kDSupplierCont
kDSupplierCont.getContentPane().setLayout(new BorderLayout(0, 0));        kDSupplierCont.getContentPane().add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.designsupplier.subill.app.DesignSupplierSelectListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("Pro.name"));
...
com.kingdee.eas.fdc.invite.designsupplier.subill.DesignSupplierSelectInfo editData = (com.kingdee.eas.fdc.invite.designsupplier.subill.DesignSupplierSelectInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
...
com.kingdee.eas.fdc.invite.designsupplier.subill.DesignSupplierSelectFactory.getRemoteInstance().unAudit(editData);
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractDesignSupplierSelectListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDesignSupplierSelectListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDesignSupplierSelectListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDesignSupplierSelectListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    protected class actionMultiSubmit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDesignSupplierSelectListUI.this, "actionMultiSubmit", "actionMultiSubmit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.designsupplier.subill.client", "DesignSupplierSelectListUI");
    }
    /**
    ...
    {
        return new String[] {"id","number","bizDate","supplierNumber.number","supplierName","InvTyep.name","Org.name","ServiceArea","Job","AuthorizedPer","AuthorizedTel","Pro.name","supplierLv.name","state","creator.name","createTime","auditor.name","auditDate","PusOrg.name"};
    }
