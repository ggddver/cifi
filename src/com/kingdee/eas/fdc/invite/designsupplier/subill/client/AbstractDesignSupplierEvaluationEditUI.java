 ...
 * output class name
 */
public abstract class AbstractDesignSupplierEvaluationEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDesignSupplierEvaluationEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contsupplierlastClas;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contresuitl;
    ...
    protected com.kingdee.bos.ctrl.swing.KDComboBox resuitl;
    protected com.kingdee.bos.ctrl.kdf.table.KDTable kdtEntrys;
	protected com.kingdee.eas.framework.client.multiDetail.DetailPanel kdtEntrys_detailPanel = null;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtPusOrg;
    protected com.kingdee.eas.fdc.invite.designsupplier.subill.DesignSupplierEvaluationInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractDesignSupplierEvaluationEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDesignSupplierEvaluationEditUI.class.getName());
        ...
        this.contsupplierlastClas = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contresuitl = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.resuitl = new com.kingdee.bos.ctrl.swing.KDComboBox();
        ...
        this.contsupplierlastClas.setName("contsupplierlastClas");
        this.contresuitl.setName("contresuitl");
        this.prmtsupplierClas.setName("prmtsupplierClas");
        this.prmtsupplierlastClas.setName("prmtsupplierlastClas");
        this.resuitl.setName("resuitl");
        ...
        // contsupplierlastClas		
        this.contsupplierlastClas.setBoundLabelText(resHelper.getString("contsupplierlastClas.boundLabelText"));		
        this.contsupplierlastClas.setBoundLabelLength(100);		
        this.contsupplierlastClas.setBoundLabelUnderline(true);		
        this.contsupplierlastClas.setVisible(true);
        // contresuitl		
        this.contresuitl.setBoundLabelText(resHelper.getString("contresuitl.boundLabelText"));		
        this.contresuitl.setBoundLabelLength(100);		
        this.contresuitl.setBoundLabelUnderline(true);		
        this.contresuitl.setVisible(true);
        // prmtsupplierClas		
        ...
        // resuitl		
        this.resuitl.addItems(EnumUtils.getEnumList("com.kingdee.eas.fdc.invite.designsupplier.designbase.ResultsEnum").toArray());		
        this.resuitl.setRequired(false);
        // kdtEntrys
		String kdtEntrysStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol0\"><c:Protection hidden=\"true\" /></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"id\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:configured=\"false\" t:styleID=\"sCol0\" /><t:Column t:key=\"Review\" t:width=\"150\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:configured=\"false\" /><t:Column t:key=\"IndexName\" t:width=\"200\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:configured=\"false\" /><t:Column t:key=\"IsQualified\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:configured=\"false\" /><t:Column t:key=\"Casedescription\" t:width=\"300\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:configured=\"false\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:configured=\"false\"><t:Cell t:configured=\"false\">id</t:Cell><t:Cell t:configured=\"false\">评审维度</t:Cell><t:Cell t:configured=\"false\">指标名称</t:Cell><t:Cell t:configured=\"false\">合格与否</t:Cell><t:Cell t:configured=\"false\">情况描述</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
        ...
        this.kdtEntrys.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
            ...
            public void editStopped(com.kingdee.bos.ctrl.kdf.table.event.KDTEditEvent e) {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","Review","IndexName","IsQualified","Casedescription"});


        this.kdtEntrys.checkParsed();
        KDTextField kdtEntrys_Review_TextField = new KDTextField();
        kdtEntrys_Review_TextField.setName("kdtEntrys_Review_TextField");
        kdtEntrys_Review_TextField.setMaxLength(100);
        KDTDefaultCellEditor kdtEntrys_Review_CellEditor = new KDTDefaultCellEditor(kdtEntrys_Review_TextField);
        this.kdtEntrys.getColumn("Review").setEditor(kdtEntrys_Review_CellEditor);
        final KDBizPromptBox kdtEntrys_IndexName_PromptBox = new KDBizPromptBox();
        kdtEntrys_IndexName_PromptBox.setQueryInfo("com.kingdee.eas.fdc.invite.designsupplier.designbase.app.DesignAuditIndexQuery");
        kdtEntrys_IndexName_PromptBox.setVisible(true);
        kdtEntrys_IndexName_PromptBox.setEditable(true);
        kdtEntrys_IndexName_PromptBox.setDisplayFormat("$number$");
        kdtEntrys_IndexName_PromptBox.setEditFormat("$number$");
        kdtEntrys_IndexName_PromptBox.setCommitFormat("$number$");
        KDTDefaultCellEditor kdtEntrys_IndexName_CellEditor = new KDTDefaultCellEditor(kdtEntrys_IndexName_PromptBox);
        this.kdtEntrys.getColumn("IndexName").setEditor(kdtEntrys_IndexName_CellEditor);
        ObjectValueRender kdtEntrys_IndexName_OVR = new ObjectValueRender();
        kdtEntrys_IndexName_OVR.setFormat(new BizDataFormat("$name$"));
        this.kdtEntrys.getColumn("IndexName").setRenderer(kdtEntrys_IndexName_OVR);
        			kdtEntrys_IndexName_PromptBox.addSelectorListener(new SelectorListener() {
			com.kingdee.eas.fdc.invite.designsupplier.designbase.client.DesignAuditIndexListUI kdtEntrys_IndexName_PromptBox_F7ListUI = null;
			public void willShow(SelectorEvent e) {
				if (kdtEntrys_IndexName_PromptBox_F7ListUI == null) {
					try {
						kdtEntrys_IndexName_PromptBox_F7ListUI = new com.kingdee.eas.fdc.invite.designsupplier.designbase.client.DesignAuditIndexListUI();
					} catch (Exception e1) {
						e1.printStackTrace();
					}
					HashMap ctx = new HashMap();
					ctx.put("bizUIOwner",javax.swing.SwingUtilities.getWindowAncestor(kdtEntrys_IndexName_PromptBox_F7ListUI));
					kdtEntrys_IndexName_PromptBox_F7ListUI.setF7Use(true,ctx);
					kdtEntrys_IndexName_PromptBox.setSelector(kdtEntrys_IndexName_PromptBox_F7ListUI);
				}
			}
		});
					
        KDComboBox kdtEntrys_IsQualified_ComboBox = new KDComboBox();
        kdtEntrys_IsQualified_ComboBox.setName("kdtEntrys_IsQualified_ComboBox");
        kdtEntrys_IsQualified_ComboBox.setVisible(true);
        kdtEntrys_IsQualified_ComboBox.addItems(EnumUtils.getEnumList("com.kingdee.eas.fdc.invite.supplier.IsGradeEnum").toArray());
        KDTDefaultCellEditor kdtEntrys_IsQualified_CellEditor = new KDTDefaultCellEditor(kdtEntrys_IsQualified_ComboBox);
        this.kdtEntrys.getColumn("IsQualified").setEditor(kdtEntrys_IsQualified_CellEditor);
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmtsupplierNumber,txtsupplierName,txtDesignType,txtDesignTypeID,txtServiceArea,txtjob,txtAuthorizedPer,txtAuthorizedTel,prmtEvaluationType,prmtsupplierTemple,pkauditDate,txtremkae,prmtPro,prmtsupplierClas,prmtsupplierlastClas,Ishg,state,prmtOrg,prmtInvTyep,resuitl,txtNumber,pkBizDate,txtDescription,prmtAuditor,prmtCreator,kDDateCreateTime,prmtLastUpdateUser,kDDateLastUpdateTime,prmtPusOrg,kdtEntrys}));
    ...
    public void initUIContentLayout()
    {
        ...
        contCreateTime.setBounds(new Rectangle(740, 576, 270, 19));
        this.add(contCreateTime, new KDLayout.Constraints(740, 576, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contLastUpdateTime.setBounds(new Rectangle(740, 601, 270, 19));
        this.add(contLastUpdateTime, new KDLayout.Constraints(740, 601, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contDesignTypeID.setBounds(new Rectangle(745, 609, 270, 19));
        this.add(contDesignTypeID, new KDLayout.Constraints(745, 609, 270, 19, 0));
        ...
        kDPanel1.setBounds(new Rectangle(3, 3, 1009, 206));
        this.add(kDPanel1, new KDLayout.Constraints(3, 3, 1009, 206, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        kDPanel2.setBounds(new Rectangle(3, 210, 1009, 59));
        this.add(kDPanel2, new KDLayout.Constraints(3, 210, 1009, 59, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contPusOrg.setBounds(new Rectangle(653, 65, 270, 19));
        this.add(contPusOrg, new KDLayout.Constraints(653, 65, 270, 19, 0));
        //contCreator
        ...
        kDPanel1.putClientProperty("OriginalBounds", new Rectangle(3, 3, 1009, 206));        contAuthorizedTel.setBounds(new Rectangle(369, 69, 270, 19));
        ...
        contsupplierName.setBounds(new Rectangle(723, 17, 270, 19));
        kDPanel1.add(contsupplierName, new KDLayout.Constraints(723, 17, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contsupplierTemple.setBounds(new Rectangle(369, 95, 270, 19));
        kDPanel1.add(contsupplierTemple, new KDLayout.Constraints(369, 95, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contstate.setBounds(new Rectangle(707, 89, 270, 19));
        kDPanel1.add(contstate, new KDLayout.Constraints(707, 89, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contOrg.setBounds(new Rectangle(650, 7, 270, 19));
        kDPanel1.add(contOrg, new KDLayout.Constraints(650, 7, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contInvTyep.setBounds(new Rectangle(661, 108, 270, 19));
        kDPanel1.add(contInvTyep, new KDLayout.Constraints(661, 108, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contIshg.setBounds(new Rectangle(644, 35, 270, 19));
        kDPanel1.add(contIshg, new KDLayout.Constraints(644, 35, 270, 19, 0));
        //contAuthorizedTel
        ...
        kDPanel2.putClientProperty("OriginalBounds", new Rectangle(3, 210, 1009, 59));        contsupplierClas.setBounds(new Rectangle(20, 19, 270, 19));
        ...
        contsupplierlastClas.setBounds(new Rectangle(335, 19, 270, 19));
        kDPanel2.add(contsupplierlastClas, new KDLayout.Constraints(335, 19, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contresuitl.setBounds(new Rectangle(630, 19, 270, 19));
        kDPanel2.add(contresuitl, new KDLayout.Constraints(630, 19, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contsupplierClas
        contsupplierClas.setBoundEditor(prmtsupplierClas);
        //contsupplierlastClas
        contsupplierlastClas.setBoundEditor(prmtsupplierlastClas);
        //contresuitl
        contresuitl.setBoundEditor(resuitl);
        //kDContainer1
kDContainer1.getContentPane().setLayout(new BorderLayout(0, 0));        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.fdc.invite.designsupplier.subill.DesignSupplierEvaluationEntryInfo(),null,false);
...
vo.put("IsQualified",new Integer(1));
			}
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("resuitl", com.kingdee.eas.fdc.invite.designsupplier.designbase.ResultsEnum.class, this.resuitl, "selectedItem");
		dataBinder.registerBinding("entrys.id", com.kingdee.bos.util.BOSUuid.class, this.kdtEntrys, "id.text");
		dataBinder.registerBinding("entrys", com.kingdee.eas.fdc.invite.designsupplier.subill.DesignSupplierEvaluationEntryInfo.class, this.kdtEntrys, "userObject");
		dataBinder.registerBinding("entrys.Review", String.class, this.kdtEntrys, "Review.text");
		dataBinder.registerBinding("entrys.IndexName", java.lang.Object.class, this.kdtEntrys, "IndexName.text");
		dataBinder.registerBinding("entrys.Casedescription", String.class, this.kdtEntrys, "Casedescription.text");
		dataBinder.registerBinding("entrys.IsQualified", com.kingdee.util.enums.Enum.class, this.kdtEntrys, "IsQualified.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.designsupplier.subill.app.DesignSupplierEvaluationEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.invite.designsupplier.subill.DesignSupplierEvaluationInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("resuitl", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.id", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.Review", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.IndexName", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.Casedescription", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.IsQualified", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("resuitl"));
    sic.add(new SelectorItemInfo("entrys.id"));
        sic.add(new SelectorItemInfo("entrys.*"));
//        sic.add(new SelectorItemInfo("entrys.number"));
    sic.add(new SelectorItemInfo("entrys.Review"));
        sic.add(new SelectorItemInfo("entrys.IndexName.*"));
//        sic.add(new SelectorItemInfo("entrys.IndexName.number"));
    sic.add(new SelectorItemInfo("entrys.Casedescription"));
    sic.add(new SelectorItemInfo("entrys.IsQualified"));
    ...
    {
        com.kingdee.eas.fdc.invite.designsupplier.subill.DesignSupplierEvaluationFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.fdc.invite.designsupplier.subill.DesignSupplierEvaluationFactory.getRemoteInstance().unAudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractDesignSupplierEvaluationEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDesignSupplierEvaluationEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.designsupplier.subill.client", "DesignSupplierEvaluationEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.fdc.invite.designsupplier.subill.client.DesignSupplierEvaluationEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/fdc/invite/designsupplier/subill/DesignSupplierEvaluation";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.fdc.invite.designsupplier.subill.app.DesignSupplierEvaluationQuery");
	}
