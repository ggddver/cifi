...
public class DesignSupplierAppraiseE2 extends CoreBillEntryBase implements IDesignSupplierAppraiseE2
{
    public DesignSupplierAppraiseE2()
    {
        super();
        registerInterface(IDesignSupplierAppraiseE2.class, this);
    }
    public DesignSupplierAppraiseE2(Context ctx)
    {
        super(ctx);
        registerInterface(IDesignSupplierAppraiseE2.class, this);
    }
    ...
    private DesignSupplierAppraiseE2Controller getController() throws BOSException
    {
        return (DesignSupplierAppraiseE2Controller)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDesignSupplierAppraiseE2Info(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignSupplierAppraiseE2Info(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignSupplierAppraiseE2Info(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignSupplierAppraiseE2Collection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignSupplierAppraiseE2Collection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignSupplierAppraiseE2Collection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
