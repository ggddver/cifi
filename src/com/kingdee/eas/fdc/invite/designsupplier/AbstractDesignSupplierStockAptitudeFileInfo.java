...
public class AbstractDesignSupplierStockAptitudeFileInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractDesignSupplierStockAptitudeFileInfo()
    {
        this("id");
    }
    protected AbstractDesignSupplierStockAptitudeFileInfo(String pkField)
    {
        super(pkField);
    }
    /**
