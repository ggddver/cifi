...
public class DemotionEntryControllerBean extends AbstractDemotionEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.invite.designsupplier.demotion.app.DemotionEntryControllerBean");
}