...
public class DesignSupplierStockSupplierAttachListEntry extends CoreBillEntryBase implements IDesignSupplierStockSupplierAttachListEntry
{
    public DesignSupplierStockSupplierAttachListEntry()
    {
        super();
        registerInterface(IDesignSupplierStockSupplierAttachListEntry.class, this);
    }
    public DesignSupplierStockSupplierAttachListEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IDesignSupplierStockSupplierAttachListEntry.class, this);
    }
    ...
    private DesignSupplierStockSupplierAttachListEntryController getController() throws BOSException
    {
        return (DesignSupplierStockSupplierAttachListEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDesignSupplierStockSupplierAttachListEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignSupplierStockSupplierAttachListEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignSupplierStockSupplierAttachListEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignSupplierStockSupplierAttachListEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignSupplierStockSupplierAttachListEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDesignSupplierStockSupplierAttachListEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
